 ...
 */
@Component
public class Notify4BaseRefund extends BaseService {

	private static final MyLog _log = MyLog.getLog(Notify4BaseRefund.class);
	...
	public JSONObject createNotifyInfo(RefundOrder refundOrder, boolean isFirst) {
		...
		if(isFirst) {
			int result = baseInsertMchNotify(refundOrder.getRefundOrderId(), refundOrder.getMchId(), refundOrder.getMchRefundNo(), PayConstant.MCH_NOTIFY_TYPE_REFUND, object.toString());
