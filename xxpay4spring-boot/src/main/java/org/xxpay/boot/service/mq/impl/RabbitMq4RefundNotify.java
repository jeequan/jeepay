...
public class RabbitMq4RefundNotify extends Mq4RefundNotify {
	...
	public void init() {
		...
		Queue queue = new Queue(MqConfig.REFUND_NOTIFY_QUEUE_NAME);
	...
	public void send(String msg) {
		...
		rabbitTemplate.convertAndSend(MqConfig.REFUND_NOTIFY_QUEUE_NAME, msg);
	}

	@Override
	public void send(String msg, long delay) {
		_log.info("发送MQ延时消息:msg={},delay={}", msg, delay);
		rabbitTemplate.convertAndSend(MqConfig.PAY_NOTIFY_EXCHANGE_NAME, MqConfig.REFUND_NOTIFY_QUEUE_NAME, msg, new MessagePostProcessor() {
